...
where it suddenly takes a shape. The shape I have in mind is a pair of feedback loops, one for
salience and one for habituated memory, that the whole network runs together. The coordinated
signal might be what you get when every cell is required to exchange its habituated state for
the unhabituated state of a signal nearby: to trade its version of the story for the waggle
dancer's.
